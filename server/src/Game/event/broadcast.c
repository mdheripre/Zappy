...
/**
 * @brief Create a broadcast event for a player.
 *
 * Allocates and initializes a game_event_t structure for broadcasting.
 *
 * @param player Pointer to the player receiving the message.
 * @param msg The message content.
 * @param to_gui Whether the message is for GUI or not.
 * @return Pointer to the created game_event_t, or NULL on failure.
 */
