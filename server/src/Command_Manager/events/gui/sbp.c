...
/**
 * @brief Handles the "sbp" command for the GUI client.
 *
 * This function sends a "sbp\n" response to the GUI client if connected.
 * It allocates a response payload and emits a send_response event.
 *
