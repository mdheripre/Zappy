...
gui::EventLog::EventLog(render::IObjectFactory &factory, const std::string &title) : _title(title)
{
...
void gui::EventLog::pushEvent(const std::string &newEvent)
{
...
bool gui::EventLog::update(float)
{
    return true;
}

void gui::EventLog::draw() const
{
